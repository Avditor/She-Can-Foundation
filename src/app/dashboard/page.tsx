  ...
  return (
    <div className="flex min-h-screen bg-[#f0f4ff]">
      ...
      <div className="w-full max-w-xs bg-white border-r border-gray-200 p-6 flex flex-col gap-4 shadow-md">
        <h1 className="text-2xl font-bold text-[#ff5c2c] mb-4 text-center">
          Dashboard
        </h1>
        <button className="px-4 py-2 rounded-lg text-left bg-[#ff5c2c] text-white">
          👤 Current User
        </button>
      </div>
      ...
      <div className="flex-1 p-10">
        <div className="bg-white rounded-2xl shadow-lg p-8 max-w-xl mx-auto space-y-6">
          {/* Current User Info */}
          <div>
            <h2 className="text-xl font-semibold text-[#ff5c2c] mb-4">
              Current User
            </h2>
          ...
          {/* Rewards Section */}
          <div>
            <h3 className="text-lg font-semibold text-[#ff5c2c] mb-3">
              🎁 Rewards / Unlockables
            </h3>
